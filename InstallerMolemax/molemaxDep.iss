...
// custom setup info
#define MyAppName "MolemaxSilver"
...
[Setup]
AppId={{B85325F6-6D1E-4431-BEAB-65E48E10ED45}
...
UninstallDisplayIcon={app}\MolemaxSilver.exe
  ...
  if ProductCount > 0 then begin
    ...
    for I := 0 to ProductCount - 1 do begin
      ...
      while True do begin
        ...
        case SuppressibleMsgBox(FmtMessage(SetupMessage(msgErrorFunctionFailed) + 'If this is a Win7 installation please download and install windows 7 security update KB3033929 then re-run the setup', [Dependencies[I].Title, IntToStr(ResultCode)]), mbError, MB_ABORTRETRYIGNORE, IDIGNORE) of
          IDABORT: begin
            Result := InstallError;
...
begin
  UserPage := CreateInputQueryPage(wpWelcome,
    'Database  Server Information', 'Database Server details',
    'Please specify Server IP Address, Port, Login name, Password then click Next.');
  UserPage.Add('IPAddress:', False);
